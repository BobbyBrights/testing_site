$(document).ready(function() {
    document.title = "Study Guides | Canadian Filmmakers Distribution Centre"
    
    $("#studyguides").addClass("educators_link_selected")
    ...
    $(".generic_table").last().append("<div class='generic_table_title'><div class='generic_title'>Study Guides</div></div>")
