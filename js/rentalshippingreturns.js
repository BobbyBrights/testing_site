$(document).ready(function() {
    ...
    $("#rentalshippingreturns").addClass("sales_rentals_link_selected")
    ...
    $(".generic_table").last().append("<div class='generic_table_title'><div class='generic_title'>Rentals Shipping/Returns</div></div>")
