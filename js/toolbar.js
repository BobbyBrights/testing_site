				...
				<div class="sub_links_container">\
					...
					<div class="sub_link_container">\
						<div class="educators_link">\
							<a href="https://cfmdcresidentscholar.wordpress.com/2017/04/12/2017-cfmdc-scholar-in-residence/">Scholar In Residence</a>\
						</div>\
					</div>\
					<div class="sub_link_spacer">\
					</div>\
...
function getSearchData() {
	...
	query_str = new_aquisition_str + "(&)" + celluloid_only_str + "(&)" + artist_str + "(&)" + title_str.replace(/'/g, '%60') + "(&)" + country_str + "(&)" + year_str + "(&)" + genre_str + "(&)" + category_str
