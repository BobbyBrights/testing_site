...
$(document).ready(function() {
    ...
    // $(".request_acct_row").last().append("<div class='request_acct_label'></div>")
    // $(".request_acct_label").last().append("<div class='request_acct_label_text'><b>First Name</b></div>")
    // $(".request_acct_row").last().append("<div class='request_acct_input'></div>")
    // $(".request_acct_input").last().append("<div class='request_acct_input_large'></div>")
    // $(".request_acct_input_large").last().append("<input type='text' id='firstname' name='firstname'>")
    // $(".request_acct_input_large").last().append("<div class='border_line'></div>")
    ...
    // $(".request_acct_row").last().append("<div class='request_acct_input'></div>")
    // $(".request_acct_input").last().append("<div class='request_acct_input_large'></div>")
    // $(".request_acct_input_large").last().append("<input type='text' id='lastname' name='lastname'>")
    // $(".request_acct_input_large").last().append("<div class='border_line'></div>")
    ...
    // $(".request_acct_table").last().append("<div class='request_acct_row'></div>")
    // $(".request_acct_row").last().append("<div class='request_acct_label'></div>")
    // $(".request_acct_label").last().append("<div class='request_acct_label_text'><b>Organization</b> (optional)</div>")
    // $(".request_acct_row").last().append("<div class='request_acct_input'></div>")
    // $(".request_acct_input").last().append("<div class='request_acct_input_large'></div>")
    // $(".request_acct_input_large").last().append("<input type='text' id='organization' name='organization'>")
    // $(".request_acct_input_large").last().append("<div class='border_line'></div>")
    ...
    // $(".request_acct_row").last().append("<div class='request_acct_input'></div>")
    // $(".request_acct_input").last().append("<div class='request_acct_input_large'></div>")
    // $(".request_acct_input_large").last().append("<input type='text' id='phone' name='phone'>")
    // $(".request_acct_input_large").last().append("<div class='border_line'></div>")
    ...
    // $(".request_acct_row").last().append("<div class='request_acct_input'></div>")
    // $(".request_acct_input").last().append("<div class='request_acct_input_large'></div>")
    // $(".request_acct_input_large").last().append("<input type='text' id='email' name='email'>")
    // $(".request_acct_input_large").last().append("<div class='border_line'></div>")
    ...
    // $(".request_acct_row").last().append("<div class='request_acct_input'></div>")
    // $(".request_acct_input").last().append("<div class='request_acct_input_large'></div>")
    // $(".request_acct_input_large").last().append("<input type='text' id='address' name='address'>")
    // $(".request_acct_input_large").last().append("<div class='border_line'></div>")
    ...
    // $(".request_acct_row").last().append("<div class='request_acct_input'></div>")
    // $(".request_acct_input").last().append("<div class='request_acct_input_large'></div>")
    // $(".request_acct_input_large").last().append("<input type='text' id='city_town' name='city_town'>")
    // $(".request_acct_input_large").last().append("<div class='border_line'></div>")
    ...
    // $(".request_acct_row").last().append("<div class='request_acct_input'></div>")
    // $(".request_acct_input").last().append("<div class='request_acct_input_small'></div>")
    // $(".request_acct_input_small").last().append("<input type='text' id='province_state' name='province_state'>")
    // $(".request_acct_input_small").last().append("<div class='border_line'></div>")
    ...
    // $(".request_acct_row").last().append("<div class='request_acct_input'></div>")
    // $(".request_acct_input").last().append("<div class='request_acct_input_large'></div>")
    // $(".request_acct_input_large").last().append("<input type='text' id='country' name='country_'>")
    // $(".request_acct_input_large").last().append("<div class='border_line'></div>")
    ...
    // $(".request_acct_row").last().append("<div class='request_acct_input'></div>")
    // $(".request_acct_input").last().append("<div class='request_acct_input_small'></div>")
    // $(".request_acct_input_small").last().append("<input type='text' id='postal_code' name='postal_code'>")
    // $(".request_acct_input_small").last().append("<div class='border_line'></div>")
