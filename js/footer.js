$(document).ready(function() {
    ...
    $('.footer_right_portion').append("<div class='links'><div class='links_'>Links</div></div>")
    $('.footer_right_portion').append("<div class='spacer'></div>")
    $('.footer_right_portion').append("<div class='links'><div class='supporters'>Supporters</div></div>")
    $('.footer_right_portion').append("<div class='spacer'></div>")
    $('.footer_right_portion').append("<div class='links'><div class='about'>About</div></div>")
    $('.footer_right_portion').append("<div class='spacer'></div>")
    $('.footer_right_portion').append("<div class='links'><div class='contact'>Contact</div></div>")
