$(document).ready(function() {
    document.title = "Rent a Film | Canadian Filmmakers Distribution Centre"
    
    $("#rentafilm").addClass("sales_rentals_link_selected")
    ...
    $(".generic_table").last().append("<div class='generic_table_title'><div class='generic_title'>Rent a Film</div></div>")
